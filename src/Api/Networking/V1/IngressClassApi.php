...
use P8p\Sdk\Schema\Networking\V1\IngressClass;
use P8p\Sdk\Schema\Networking\V1\IngressClassList;

class IngressClassApi extends AbstractApi
{
    /**
     ...
     *
     * @return Response<IngressClassList>
     */
    public function list(array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            ...
            responseClass: IngressClassList::class,
     ...
     *
     * @return Response<IngressClass>
     */
    public function create(IngressClass $body, array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            verb: 'POST',
            path: '/apis/networking.k8s.io/v1/ingressclasses',
            responseClass: IngressClass::class,
            body: $body,
            queryParameters: $queryParameters,
        );
    }
     ...
     * @return Response<IngressClass>
     */
    public function replace(string $name, IngressClass $body, array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            verb: 'PUT',
            path: '/apis/networking.k8s.io/v1/ingressclasses/{name}',
