...
use P8p\Sdk\Schema\Networking\V1\IPAddress;
use P8p\Sdk\Schema\Networking\V1\IPAddressList;

class IPAddressApi extends AbstractApi
{
    /**
    ...
    public function list(array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            ...
            responseClass: IPAddressList::class,
     ...
     */
    public function create(IPAddress $body, array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            verb: 'POST',
            path: '/apis/networking.k8s.io/v1/ipaddresses',
            responseClass: IPAddress::class,
            body: $body,
            queryParameters: $queryParameters,
        );
    }
     ...
     * @return Response<IPAddress>
     */
    public function replace(string $name, IPAddress $body, array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            verb: 'PUT',
            path: '/apis/networking.k8s.io/v1/ipaddresses/{name}',
