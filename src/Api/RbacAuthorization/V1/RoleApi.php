...
use P8p\Sdk\Schema\RbacAuthorization\V1\RoleList;

class RoleApi extends AbstractApi
{
    /**
     ...
     */
    public function create(string $namespace, Role $body, array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            verb: 'POST',
            path: '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles',
     ...
     * @return Response<Role>
     */
    public function replace(string $name, string $namespace, Role $body, array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            verb: 'PUT',
            path: '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles/{name}',
