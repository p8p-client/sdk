...
namespace P8p\Sdk\Api\Node\V1;

use P8p\Client\Api\AbstractApi;
use P8p\Client\Response;
use P8p\Sdk\Schema\Meta\V1\DeleteOptions;
use P8p\Sdk\Schema\Meta\V1\Status;
use P8p\Sdk\Schema\Node\V1\RuntimeClass;
use P8p\Sdk\Schema\Node\V1\RuntimeClassList;

class RuntimeClassApi extends AbstractApi
{
    /**
     ...
     *
     * @return Response<RuntimeClassList>
     */
    public function list(array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            ...
            responseClass: RuntimeClassList::class,
     ...
     *
     * @return Response<RuntimeClass>
     */
    public function create(RuntimeClass $body, array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            verb: 'POST',
            path: '/apis/node.k8s.io/v1/runtimeclasses',
            responseClass: RuntimeClass::class,
            body: $body,
            queryParameters: $queryParameters,
        );
    }
     ...
     * @return Response<RuntimeClass>
     */
    public function replace(string $name, RuntimeClass $body, array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            verb: 'PUT',
            path: '/apis/node.k8s.io/v1/runtimeclasses/{name}',
