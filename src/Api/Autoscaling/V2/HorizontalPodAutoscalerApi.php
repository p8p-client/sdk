...
namespace P8p\Sdk\Api\Autoscaling\V2;

use P8p\Client\Api\AbstractApi;
use P8p\Client\Response;
use P8p\Sdk\Schema\Autoscaling\V2\HorizontalPodAutoscaler;
use P8p\Sdk\Schema\Autoscaling\V2\HorizontalPodAutoscalerList;
