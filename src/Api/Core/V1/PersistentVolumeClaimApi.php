...
use P8p\Sdk\Schema\Core\V1\PersistentVolumeClaimList;
use P8p\Sdk\Schema\Core\V1\Status;

class PersistentVolumeClaimApi extends AbstractApi
{
    /**
     ...
     *
     * @return Response<PersistentVolumeClaimList>
     */
    public function list(string $namespace, array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            ...
            responseClass: PersistentVolumeClaimList::class,
     ...
     *
     * @return Response<PersistentVolumeClaim>
     */
    public function create(string $namespace, PersistentVolumeClaim $body, array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            verb: 'POST',
            path: '/api/v1/namespaces/{namespace}/persistentvolumeclaims',
            pathParameters: ['namespace' => $namespace],
            responseClass: PersistentVolumeClaim::class,
            body: $body,
            queryParameters: $queryParameters,
        );
    }
