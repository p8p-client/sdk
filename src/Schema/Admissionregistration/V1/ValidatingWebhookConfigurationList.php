...
#[K8sSchemaRef(name: 'io.k8s.api.admissionregistration.v1.ValidatingWebhookConfigurationList')]
#[K8sSchema(kind: 'ValidatingWebhookConfigurationList', group: 'admissionregistration.k8s.io', version: 'v1')]
class ValidatingWebhookConfigurationList
{
    /**
     * @param array<int, ValidatingWebhookConfiguration> $items    list of ValidatingWebhookConfiguration
