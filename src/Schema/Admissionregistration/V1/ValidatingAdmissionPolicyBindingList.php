...
#[K8sSchemaRef(name: 'io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingList')]
#[K8sSchema(kind: 'ValidatingAdmissionPolicyBindingList', group: 'admissionregistration.k8s.io', version: 'v1')]
