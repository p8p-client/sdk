...
#[K8sSchemaRef(name: 'io.k8s.api.networking.v1.IPAddressList')]
#[K8sSchema(kind: 'IPAddressList', group: 'networking.k8s.io', version: 'v1')]
class IPAddressList
{
    /**
     * @param array<int, IPAddress> $items    items is the list of IPAddresses
