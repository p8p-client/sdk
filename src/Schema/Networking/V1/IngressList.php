...
#[K8sSchemaRef(name: 'io.k8s.api.networking.v1.IngressList')]
#[K8sSchema(kind: 'IngressList', group: 'networking.k8s.io', version: 'v1')]
class IngressList
{
    /**
     * @param array<int, Ingress> $items    items is the list of Ingress
