...
#[K8sSchemaRef(name: 'io.k8s.api.batch.v1.CronJobList')]
#[K8sSchema(kind: 'CronJobList', group: 'batch', version: 'v1')]
class CronJobList
{
    /**
     * @param array<int, CronJob> $items    items is the list of CronJobs
