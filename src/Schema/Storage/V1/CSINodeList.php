...
#[K8sSchemaRef(name: 'io.k8s.api.storage.v1.CSINodeList')]
#[K8sSchema(kind: 'CSINodeList', group: 'storage.k8s.io', version: 'v1')]
class CSINodeList
{
    /**
     * @param array<int, CSINode> $items    items is the list of CSINode
