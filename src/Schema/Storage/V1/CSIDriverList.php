...
#[K8sSchemaRef(name: 'io.k8s.api.storage.v1.CSIDriverList')]
#[K8sSchema(kind: 'CSIDriverList', group: 'storage.k8s.io', version: 'v1')]
class CSIDriverList
{
    /**
     * @param array<int, CSIDriver> $items    items is the list of CSIDriver
