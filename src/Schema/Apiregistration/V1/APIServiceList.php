...
#[K8sSchemaRef(name: 'io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceList')]
#[K8sSchema(kind: 'APIServiceList', group: 'apiregistration.k8s.io', version: 'v1')]
class APIServiceList
{
    /**
     * @param array<int, APIService> $items    Items is the list of APIService
