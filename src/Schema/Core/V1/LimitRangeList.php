...
#[K8sSchemaRef(name: 'io.k8s.api.core.v1.LimitRangeList')]
#[K8sSchema(kind: 'LimitRangeList', group: '', version: 'v1')]
class LimitRangeList
{
    /**
     * @param array<int, LimitRange> $items    Items is a list of LimitRange objects. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
