...
#[K8sSchemaRef(name: 'io.k8s.api.core.v1.ResourceRequirements')]
class ResourceRequirements
{
    /**
     * @param array<int, ResourceClaim>|null $claims Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container.
     *
