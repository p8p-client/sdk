...
#[K8sSchemaRef(name: 'io.k8s.api.core.v1.ComponentStatusList')]
#[K8sSchema(kind: 'ComponentStatusList', group: '', version: 'v1')]
class ComponentStatusList
{
    /**
     * @param array<int, ComponentStatus> $items    list of ComponentStatus objects
