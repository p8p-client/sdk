...
#[K8sSchemaRef(name: 'io.k8s.api.core.v1.StorageOSVolumeSource')]
class StorageOSVolumeSource
{
     ...
     * @param LocalObjectReference|null $secretRef       secretRef specifies the secret to use for obtaining the StorageOS API credentials.  If not specified, default values will be attempted.
