...
#[K8sSchemaRef(name: 'io.k8s.api.core.v1.ScaleIOPersistentVolumeSource')]
class ScaleIOPersistentVolumeSource
{
    /**
     * @param string          $gateway          gateway is the host address of the ScaleIO API Gateway
     * @param SecretReference $secretRef        secretRef references to the secret for ScaleIO user and other sensitive information. If this is not provided, Login operation will fail.
     ...
     * @param bool|null       $sslEnabled       sslEnabled is the flag to enable/disable SSL communication with Gateway, default false
