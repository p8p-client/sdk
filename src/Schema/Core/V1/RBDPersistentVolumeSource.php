...
#[K8sSchemaRef(name: 'io.k8s.api.core.v1.RBDPersistentVolumeSource')]
class RBDPersistentVolumeSource
{
     ...
     * @param SecretReference|null $secretRef secretRef is name of the authentication secret for RBDUser. If provided overrides keyring. Default is nil. More info: https://examples.k8s.io/volumes/rbd/README.md#how-to-use-it
