...
#[K8sSchemaRef(name: 'io.k8s.api.core.v1.CephFSPersistentVolumeSource')]
class CephFSPersistentVolumeSource
{
     ...
     * @param SecretReference|null $secretRef  secretRef is Optional: SecretRef is reference to the authentication secret for User, default is empty. More info: https://examples.k8s.io/volumes/cephfs/README.md#how-to-use-it
