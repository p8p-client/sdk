...
#[K8sSchemaRef(name: 'io.k8s.api.core.v1.PodTemplateList')]
#[K8sSchema(kind: 'PodTemplateList', group: '', version: 'v1')]
class PodTemplateList
{
    /**
     * @param array<int, PodTemplate> $items    List of pod templates
